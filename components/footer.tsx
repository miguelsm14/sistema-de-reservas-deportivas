        ...
        <div className="flex flex-col flex-1 items-center md:items-end gap-6 text-center md:text-right">
          ...
          <div className="flex gap-x-12 gap-y-8 flex-row items-start justify-center md:justify-end">
            ...
            <div className="flex flex-col items-center md:items-end gap-3 transition-transform hover:-translate-y-1">
              <span className="text-sm font-medium text-foreground">Miguel Sánchez</span>
              <div className="flex items-center gap-4">
                ...
                <a href="#" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-[#1DA1F2] transition-colors" aria-label="X (Twitter) de Miguel">
                  <Twitter className="h-5 w-5" />
                </a>
                <a href="#" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-[#E1306C] transition-colors" aria-label="Instagram de Miguel">
            ...
            {/* Cofounder 2 */}
            <div className="flex flex-col items-center md:items-end gap-3 transition-transform hover:-translate-y-1">
              <span className="text-sm font-medium text-foreground">Co-fundador 2</span>
              <div className="flex items-center gap-4">
